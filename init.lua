...
-- Copy Past clipboard
vim.keymap.set("v", "<leader>y", "<cmd>\"+y<CR>", { desc = "Copy to clipboard", noremap = true, silent = true })
vim.keymap.set("v", "<leader>p", "<cmd>\"+p<CR>", { desc = "Past from clipboard", noremap = true, silent = true })
...
vim.keymap.set("n", "<leader>/", "<cmd>FzfLua grep_curbuf<CR>", { desc = "[/] Fuzzily search in current buffer" })
